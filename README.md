...
<div>
  ...
  ## 🙌 어떤 프로젝트를 진행했나요?
  ### 👨‍💼 현재 시장에 존재하는 면접 연습 플랫폼은 대부분 직무에 대한 특화 없이, 표준화된 질문을 제시하는 데 그칩니다. 하지만 개발 직무는 기술 스택, 도메인, 포지션에 대한 시나리오에 따라 다른 질문과 준비가 필요합니다. 그래서 JobStick에서는 IT 직무에 특화된 AI 모의 면접 플랫폼을 제시합니다.
